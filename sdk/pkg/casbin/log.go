...
func (l *Logger) LogModel(model [][]string) {
	...
	logger.Wrapper.GetLogger().Log(context.Background(), zerolog.InfoLevel, str)
}
...
func (l *Logger) LogPolicy(policy map[string][][]string) {
	...
	logger.Wrapper.GetLogger().Fields(data).Log(context.Background(), zerolog.InfoLevel, nil)
}

//func (l *Logger) Print(v ...interface{}) {
//	if l.IsEnabled() {
//		logger.Wrapper.GetLogger().Log(logger.InfoLevel, v...)
//	}
//}
//
//func (l *Logger) Printf(format string, v ...interface{}) {
//	if l.IsEnabled() {
//		logger.Wrapper.GetLogger().Logf(logger.InfoLevel, format, v...)
//	}
//}
