...
func init() {
	...
	DefaultLogger.SetLogger(NewHelper(NewLogger(WithLevel(lvl))))
}
...
func Infof(ctx context.Context, format string, args ...any) {
	DefaultLogger.GetLogger().Native().(*defaultLogger).infof(ctx, format, nil, args...)
}
...
func Tracef(ctx context.Context, format string, args ...any) {
	DefaultLogger.GetLogger().Native().(*defaultLogger).debugf(ctx, format, nil, args...)
}
...
func Warnf(ctx context.Context, format string, args ...any) {
	DefaultLogger.GetLogger().Native().(*defaultLogger).warnf(ctx, format, nil, args...)
}
...
func Errorf(ctx context.Context, err error, format string, args ...any) {
	DefaultLogger.GetLogger().Native().(*defaultLogger).errorf(ctx, err, format, nil, args...)
}
...
func Fatalf(ctx context.Context, err error, format string, args ...any) {
	DefaultLogger.GetLogger().Native().(*defaultLogger).fatalf(ctx, err, format, nil, args...)
}
